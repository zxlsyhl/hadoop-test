...
public class MaxTemperatureDriver2 extends Configured implements Tool {
...
//        CombineTextInputFormat.addInputPath(job, new Path(args[0]));
        ...
        job.setInputFormatClass(CombineTextInputFormat.class);//使用CombineFileInputFormat可以合并输入的小文件，减少map数量，提高效率。
...
//        job.setPartitionerClass(HashPartitioner.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new MaxTemperatureDriver2(), args);
